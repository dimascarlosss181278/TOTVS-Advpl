#Include "Matr120_CL.ch"
#Include "FIVEWIN.Ch"
/*/
ÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜ
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄ¿±±
±±³Fun‡…o    ³ MATR120_CL  ³ Autor ³ Nereu Humberto Junior ³ Data ³ 12.06.06  ³±±
...
TRCell():New(oSection2,"C7_USER","SC7","Comprador",/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
TRCell():New(oSection2,"cStatus","   ","Status",/*Picture*/,/*Tamanho*/,/*lPixel*/,{|| ImpStatus(cAliasSC7) })
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß*/
Static Function ImpStatus(cAliasSC7)
...
DO CASE
	CASE !Empty((cAliasSC7)->C7_RESIDUO)
		cStatus := "Eliminado por Residuo"
	CASE (cAliasSC7)->C7_CONAPRO=="B".And.(cAliasSC7)->C7_QUJE < (cAliasSC7)->C7_QUANT
		cStatus := "Bloqueado"
	CASE (cAliasSC7)->C7_QUJE==0 .And. (cAliasSC7)->C7_QTDACLA==0 
		cStatus := "Pendente"
	CASE (cAliasSC7)->C7_QUJE<>0.And.(cAliasSC7)->C7_QUJE<(cAliasSC7)->C7_QUANT
		cStatus := "Pedido Parcialmente Atendido"
	CASE (cAliasSC7)->C7_QUJE>=(cAliasSC7)->C7_QUANT
		cStatus := "Pedido Atendido"
	CASE (cAliasSC7)->C7_QTDACLA >0
		cStatus := "Pedido Usado em Pre-Nota"
	OTHERWISE
		cStatus := "Outros"
ENDCASE
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄ¿±±
±±³Fun‡…o    ³MATR120R3_CL ³ Autor ³ Claudinei M. Benzi    ³ Data ³ 05.09.91  ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄ´±±
...
±±³Descri‡…o ³ PLANO DE MELHORIA CONTINUA        ³Programa    MATR120_CL.PRX ³±±
